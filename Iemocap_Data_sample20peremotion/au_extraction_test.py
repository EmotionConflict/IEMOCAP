...
if __name__ == "__main__":
    ...
    # OPENFACE_PATH = "/Users/summerghorbani/openface/bin/FeatureExtraction"
    # INPUT_FOLDER = "/Users/summerghorbani/Documents/MIT_projects/How2AI/IEMOCAP_full_release/test_video/Session1_Video"
    # TRANSCRIPT_FILE = "/Users/summerghorbani/Documents/MIT_projects/How2AI/IEMOCAP_full_release/test_video/Session1_Text"
    # # TRANSCRIPT_FILE = "../data/IEMOCAP_transcripts.json"  # { "utterance_id": "text" }
    # OUTPUT_FOLDER = "../outputs_iemocap_session1_imp02"
    # FRAME_TEMP_PATH = "temp_frame.jpg"
    parser = argparse.ArgumentParser(description="Extract Action Units from videos using OpenFace")
    parser.add_argument("--data_dir", type=str, default="/Users/summerghorbani/Documents/MIT_projects/How2AI/IEMOCAP_full_release/test_video/sample20peremotion/au",
                       help="Directory containing the video files")
    parser.add_argument("--output_dir", type=str, default="/Users/summerghorbani/Documents/MIT_projects/How2AI/IEMOCAP_full_release/test_video/sample20peremotion/au",
                       help="Directory to save OpenFace outputs")
    parser.add_argument("--openface_bin", type=str, 
                       default="/Users/summerghorbani/openface/bin/FeatureExtraction",
    ...
    if args.specific_files:
        ...
        all_videos = glob.glob(os.path.join(args.data_dir, "*.csv"))
